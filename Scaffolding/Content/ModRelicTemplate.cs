...
namespace STS2RitsuLib.Scaffolding.Content
{
    ...
    ///     Mod 遗物的基础 <c>RelicModel</c>：提供可选能量悬浮提示、关键词提示，以及
    ///     <c>IModRelicAssetOverrides</c> 路径。
    /// </summary>
    public abstract class ModRelicTemplate : RelicModel, IModRelicAssetOverrides
    {
        ...
        ///     要显示在此遗物悬浮提示上的卡牌式关键词 id。<b>仅用于显示</b>：不同于
        ///     <c>ModCardTemplate.RegisteredKeywordIds</c>，它不会参与任何游戏逻辑关键词集合
        ///     （原版 <c>RelicModel</c> 没有 <c>Keywords</c>/<c>CardKeyword</c> 存储）。每个 id

...
namespace STS2RitsuLib.Scaffolding.Characters
{
    ...
    ///     (powers, orbs, energy).
    ///     <see cref="Creature" /> 和 <see cref="Player" /> 的常用战斗查询扩展方法（能力、充能球、能量）。
    /// </summary>
    public static class CharacterCombatExtensions
    {
        ...
        ///     返回第一个类型为 <typeparamref name="TPower" /> 的激活能力实例；若不存在则返回 null。
        /// </summary>
        ...
        ///     此生物当前是否至少拥有 <paramref name="minimumAmount" /> 层 <typeparamref name="TPower" />。
        /// </summary>
        ...
        ///     <typeparamref name="TPower" /> 的当前层数；不存在时为 0。
        /// </summary>
        ...
        ///     玩家充能球队列当前是否至少包含一个类型为 <typeparamref name="TOrb" /> 的充能球。
        /// </summary>
        ...
        ///     统计队列中类型为 <typeparamref name="TOrb" /> 的充能球数量。
        /// </summary>

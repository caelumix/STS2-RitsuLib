...
namespace STS2RitsuLib.Scaffolding.Content
{
    ...
    ///     Mod act 的基础 <c>ActModel</c>：提供宝箱 Spine 路径覆盖、<c>IModActAssetOverrides</c>
    ///     场景/地图路径，以及可选的自定义战斗背景图层目录（<c>_bg_</c> / <c>_fg_</c> 场景）。
    ///     若要复用原版 act 随游戏发布的美术，请从 <c>ContentAssetProfiles.FromVanillaActId</c> 设置
    ///     <c>AssetProfile</c>（使用原版文件夹名，而不是此 act 的模型 id）。
    /// </summary>

...
namespace STS2RitsuLib.Scaffolding.Content
{
    ...
    ///     overlay path.
    ///     Mod 苦痛的基础 <c>AfflictionModel</c>：提供关键词悬浮提示和
    ///     <c>IModAfflictionAssetOverrides</c> 覆盖层路径。
    /// </summary>
    public abstract class ModAfflictionTemplate : AfflictionModel, IModAfflictionAssetOverrides
    {
        ...
        ///     要显示在此苦痛悬浮提示上的关键词 id。<b>仅用于显示</b>：不同于
        ///     <c>ModCardTemplate.RegisteredKeywordIds</c>，它不会参与任何游戏逻辑关键词集合
        ///     （原版 <c>AfflictionModel</c> 没有 <c>Keywords</c>/<c>CardKeyword</c> 存储）。每个 id

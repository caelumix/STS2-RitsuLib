...
{
    /// <summary>
    ///     Typed model component base that opts into the owning model's vanilla hook listener stream when that owner
    ///     participates in vanilla hooks.
    ///     当 owner 参与原版 hook 时，会插入所属模型原版 hook listener 流的类型化模型组件基类。
    /// </summary>
    public abstract class OwnerHookModelComponent<TModel> : ModelComponent<TModel>, IModelComponentHookListener
    ...
    /// </summary>
    public abstract class CardComponent : OwnerHookModelComponent<CardModel>
    {
        /// <summary>
    ...
    ///     带受保护默认组件钩子的卡牌基类。
    /// </summary>
    public abstract class ComponentCardModel : CardModel, IModelComponentProvider
    {
        /// <summary>
        ///     Creates a card model with default-component support.
        ///     创建支持默认组件的卡牌模型。
        /// </summary>
        protected ComponentCardModel(
        ...
        void IModelComponentProvider.BuildDefaultComponents(ModelDefaultComponentList components)
        {
            BuildDefaultComponents(components);
        }
        ...
        ///     添加此卡牌自身的默认组件。
        /// </summary>
        protected virtual void BuildDefaultComponents(ModelDefaultComponentList components)
        {
        }
    }
    ...
    ///     遗物 owner 行为组件基类。
    /// </summary>
    public abstract class RelicComponent : OwnerHookModelComponent<RelicModel>
    {
    }
    ...
    ///     药水 owner 行为组件基类。
    /// </summary>
    public abstract class PotionComponent : OwnerHookModelComponent<PotionModel>
    {
    }
    ...
    ///     能力 owner 行为组件基类。
    /// </summary>
    public abstract class PowerComponent : OwnerHookModelComponent<PowerModel>
    {
    }
    ...
    ///     充能球 owner 行为组件基类。
    /// </summary>
    public abstract class OrbComponent : OwnerHookModelComponent<OrbModel>
    {
    }
    ...
    ///     附魔 owner 行为组件基类。
    /// </summary>
    public abstract class EnchantmentComponent : OwnerHookModelComponent<EnchantmentModel>
    {
    }
    ...
    ///     苦痛 owner 行为组件基类。
    /// </summary>
    public abstract class AfflictionComponent : OwnerHookModelComponent<AfflictionModel>
    {
    }
    ...
    ///     怪物 owner 行为组件基类。
    /// </summary>
    public abstract class MonsterComponent : OwnerHookModelComponent<MonsterModel>
    {
    }
    ...
    /// </summary>
    public abstract class CharacterComponent : ModelComponent<CharacterModel>
    {
    }
    ...
    ///     处理所属卡牌打出事件的卡牌组件基类。
    /// </summary>
    public abstract class CardPlayedComponent : CardComponent
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public abstract class OneShotCardPlayedComponent : CardPlayedComponent
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public abstract class UntilCombatEndComponent<TModel> : OwnerHookModelComponent<TModel>
        where TModel : AbstractModel
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public abstract class TurnLimitedComponent<TModel> : OwnerHookModelComponent<TModel>
        where TModel : AbstractModel
    {
        ...
        ///     创建剩余一回合的组件。
        /// </summary>
        protected TurnLimitedComponent()
        {
        }
        ...
        /// </summary>
        protected TurnLimitedComponent(int remainingTurns)
        {

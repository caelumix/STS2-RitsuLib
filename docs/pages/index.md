...
- 运行时侧：生命周期事件订阅、补丁辅助、设置界面、持久化迁移、次级资源与卡牌附加费用
...
| 编写战斗资源 | 次级资源、卡牌附加费用、资源图标与战斗 UI 路由 | [/guide/secondary-resources](/guide/secondary-resources) |
...
| Build combat resources | Secondary resources, attached card costs, icon text helpers, and combat UI routing | [/guide/secondary-resources](/guide/secondary-resources) |

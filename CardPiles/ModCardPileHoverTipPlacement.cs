namespace STS2RitsuLib.CardPiles
{
    ...
    ///     mod pile 按钮如何相对 pile control 放置 hover tip。当固定自动规则不适合你的
    ///     <c>ModCardPileAnchorKind.Custom</c> 布局时，使用非 <c>Auto</c> 值
    ///     （例如固定在屏幕底部附近的 pile 通常需要 <c>AboveButtonCentered</c>，让 tip 从按钮向上展开）。
    /// </summary>
    public enum ModCardPileHoverTipPlacement
    {
        ...
        ///     放置方式遵循 <c>ModCardPileUiStyle</c>、<c>ModCardPileAnchorKind</c>，
        ///     以及 <c>Nodes.NModCardPileButton</c> 内的 top-bar deck 规则。
        /// </summary>
        Auto = 0,
        ...
        ///     tip 位于 anchor rect 上方并水平居中；内容向上展开（适合 pile 位于屏幕较低处时）。
        /// </summary>
        ...
        ///     tip 位于 anchor rect 下方并水平居中；内容向下展开（适合 pile 位于屏幕较高处时）。
        /// </summary>

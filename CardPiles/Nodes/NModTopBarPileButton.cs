namespace STS2RitsuLib.CardPiles.Nodes
{
    ...
    ///     针对 top-bar pile 的 <c>NModCardPileButton</c> 薄 specialization。目前原样复用基类按钮；
    ...
    public sealed partial class NModTopBarPileButton
    {
        ...
        ///     为 <c>definition</c> 构建新的 top-bar 按钮。目前它生成与
        ///     <c>NModCardPileButton.Create</c> 相同的节点；独立类可以简化在 scene tree 中识别 top-bar 实例。
        /// </summary>

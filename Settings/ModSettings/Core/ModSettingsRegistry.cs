namespace STS2RitsuLib.Settings
{
    ...
    public static class ModSettingsRegistry
    {
        ...
        ///     在页面注册后覆盖 <see cref="ModSettingsPage.SortOrder" />（键为复合 id）。
        /// </summary>
        ...
        ///     注册设置 chrome 中为 <paramref name="modId" /> 显示的本地化（或字面量）文本。
        /// </summary>
        ...
        ///     返回 <paramref name="modId" /> 的显示名称（如果存在）。
        /// </summary>
        ...
        ///     注册此 Mod 分组在设置侧边栏中的排序。<paramref name="order" /> 越小越靠前。
        ...
        ///     覆盖页面在同级页面中的排序键（相同 <see cref="ModSettingsPage.ModId" /> 和
        ///     <see cref="ModSettingsPage.ParentPageId" />）。数值越小越靠前；相同值按页面 id 打破平局。
        /// </summary>
        ...
        ///     当 <paramref name="afterPageId" /> 存在时返回 <see langword="true" />。
        /// </returns>
        ...
        ///     当 <paramref name="beforePageId" /> 存在时返回 <see langword="true" />。
        /// </returns>
        ...
        ///     <paramref name="modId" /> 的侧边栏分组排序；未设置时为 <c>0</c>。
        /// </summary>
        ...
        ///     <paramref name="page" /> 的有效排序键（覆盖值或 <see cref="ModSettingsPage.SortOrder" />）。
        /// </summary>
        ...
        ///     流式辅助方法：通过 <paramref name="configure" /> 构建页面并注册。
        /// </summary>
